...
export const NavBar = () => {
  return (
    <div className="top-0 py-1 lg:py-2 w-full bg-transparent lg:relative z-50 dark:bg-gray-700">
    <nav className="z-10 sticky top-0 left-0 right-0 max-w-4xl xl:max-w-5xl mx-auto px-5 py-2.5 lg:border-none lg:py-4">
        <div className="flex items-center justify-between">
            <button>
                <div className="flex items-center space-x-2">
                    <h2 className="text-black dark:text-white font-bold text-2xl">Transiett</h2>
                </div>
            </button>
            ...
            <div className="hidden lg:flex lg:items-center gap-x-2">
                <a href="/api/vouchers/all" className="flex items-center text-black dark:text-white justify-center px-6 py-2.5 font-semibold" download>Download Vouchers</a>
            </div>
